...
<script>
            ...
            if(res){
            location.replace("./deleteProd?id="+id);
            }
           }
</script>
<!DOCTYPE html>
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= p.getPrix()%></td>
                                    <td><button style="color: white; background: #52d3ed; padding: 1px 30px;margin: 0 20px;" onclick="confirmer(<%= p.getId()%>)">Supprimer</button></td>
                                </tr>

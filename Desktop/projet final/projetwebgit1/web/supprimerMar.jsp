...
<script>
            ...
            if(res){
            location.replace("./deleteMar?id="+id);
            }
           }
</script>
<!DOCTYPE html>
                            ...
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><%= i++%></th>
                                        <td><%= m.getNom()%></td>
                                        <td><button style="color: white; background: #52d3ed; padding: 1px 30px;margin: 0 20px;" onclick="confirmer(<%= m.getId()%>)">Supprimer</button></td>

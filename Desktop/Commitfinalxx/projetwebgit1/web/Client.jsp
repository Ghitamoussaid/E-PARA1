...
Client cl = ccs.findById(id_user);%>
                <%!int n = 0;%>
...
<body>
    ...
    <header class="header_section">
      <div class="container">
        <div class="top_contact-container">
          <div class="tel_container">
            <a href="">
              <img src="images/telephone-symbol-button.png" alt=""> Call : +212 522977354
            </a>
          </div>
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          <a class="navbar-brand" href="http://localhost:8080/Client.jsp">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="afficheCommandeClient.jsp"> Commandes </a>
                </li>
                <li class="nav-item">
              ...
              <form class="form-inline ">
                ...
                <div class="login_btn-contanier ml-0 ml-lg-5" style="    display: flex;
    flex-direction: row;">
                
                  <img src="images/user.png" alt="">

                  <span style="color: white;">
                    <%=cl.getNom()+" "+cl.getPrenom()%></span>
                    <a href="login.html" style="margin: 0 2px;"><i class="fa fa-sign-out" aria-hidden="true"></i></a>                  
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/ghita00.jfif" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      Paraluxe.ma is the largest e-commerce site for the delivery of parapharmaceutical products in Morocco, with more than 10,000 references. We deliver the products everywhere in Morocco.
                    <div>
                      <a href="">
                        Buy Now
                      </a>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/ACCEUIL2.jpg" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      Welcome To Our <br>
                      <span>Online parapharmacy
                      </span>

                    </h1>
                    <p>
                      We offer more than 100 brands, among them the best known: Vichy, Avène, Yves Roches, La Roche Posay, SVR, Eucerin?.etc
                    </p>
                    <div>
                      <a href="">
                        Buy Now
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/ghita000.jfif" alt="">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>
                      We have over 10,000 products online
                    </p>
                    <div>
                      <a href="">
                        Buy Now
 ...
 <section class="feature_section  layout_padding">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-5">
          <div class="img-box">
            <img src="images/acceuil3.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="health_section layout_padding" id="produits">
    ...
    flex-wrap: wrap;">
              ...
              <div class="">
                  <form action="filtreClient.jsp" method="POST">
                  <select name="marque" style="    padding: 10px 45px;
    background-color: #1e1d1d;
    color: #ffffff;
    margin-top: 35px;margin-right: 30px; width: 240px;">
                  ...
                  <select name="categorie"  style="    padding: 10px 45px;
    background-color: #1e1d1d;
    color: #ffffff;
    margin-top: 35px;margin-right: 30px;width: 240px;">
                  ...
                  <input style="color: white; background: #52d3ed; padding: 10px 45px;
    margin-top: 35px;margin-right: 30px; width: 200px;" type="submit" value="Filtrer" name="Filtrer" />
                 </form>
              </div>

              <a href="panier.jsp"> <img src="images/shop2.png" alt=""> <%= n%></a>
          </div>
              ...
              <div class="owl-carousel owl-2">
                  <%
                      ...
                      for (Produit p : ps.findAll()) {
                          if((p.getMarque().getNom()).equals("La Roche")){
                  %> 
                  <div class="item">
                      <div class="box">
                          <div class="btn_container">
                              <a href="AjouterPanier?id=<%= p.getId()%>&user=<%= u.getId()%>">
                                  Buy Now
                              </a>
                          </div>
                          <div class="img-box">
                              <img height="298px" weight="298px" src="images/<%= p.getImage()%>" alt="">
                          </div>
                          <div class="detail-box">
          ...
          <div class="carousel-wrap layout_padding2">
              <div class="owl-carousel owl-2">
                  <%
                      ...
                      for (Produit p : ps.findAll()) {
                          if((p.getMarque().getNom()).equals("Vita")){
                  %> 
                  <div class="item">
                      <div class="box">
                          <div class="btn_container">
          ...
          <div class="carousel-wrap layout_padding2">
              <div class="owl-carousel owl-2">
                  <%
                      ...
                      for (Produit p : ps.findAll()) {
                          if((p.getMarque().getNom()).equals("Cerave")){
                  %> 
                  <div class="item">
                      <div class="box">
                          <div class="btn_container">
          ...
          <div class="carousel-wrap layout_padding2">
              <div class="owl-carousel owl-2">
                  <%
                      ...
                      for (Produit p : ps.findAll()) {
                          if((p.getMarque().getNom()).equals("ACM")){
                  %> 
                  <div class="item">
                      <div class="box">
                          <div class="btn_container">
              ...
              <div class="carousel-inner">
                  <div class="carousel-item active">
                      <div class="client_container layout_padding2">
                          <div class="client_detail">
                              <p>
                                  ?I placed an order on Tuesday and it was delivered on Wednesday, frankly I am surprised by the quality of the service. well done"
                              </p>
                          </div>
                          <div class="client_box ">
                              <div class="img-box">
                                  <img src="images/client1.jfif"  style= "border-radius:50%;height:70px;" alt= "">
                              </div>
                              <div class="name">
                                  <h5>
                                      Randomised
                  ...
                  <div class="carousel-item">
                      <div class="client_container layout_padding2">
                          <div class="client_detail">
                              <p>
                                  ?I have become a loyal customer because I am satisfied with the service and also with the promotions each time. A very wide choice of products.
                                  Best wishes"
                              </p>
                          </div>
                          <div class="client_box ">
                              <div class="img-box">
                                  <img src="images/client2.jpg" style="border-radius:50%;height:70px" alt="">
                              </div>
                              <div class="name">
                                  <h5>
                                      Randomised
                  ...
                  <div class="carousel-item">
                      <div class="client_container layout_padding2">
                          <div class="client_detail">
                              <p>
                                  ?I have had experiences with other Para companies. When I give E-PARA a ten.
                              </p>
                          </div>
                          <div class="client_box ">
                              <div class="img-box">
                                  <img src="images/client3.png " style="border-radius:50%;height:70px" alt="">
                              </div>
                              <div class="name">
                                  <h5>
                                      Randomised
                      ...
                      <form>
                          ...
                          <div class="form-group ">
                              ...
                              <select id="inputState" class="form-control">
                                  ...
                                  <option selected>Cosmetic</option>
